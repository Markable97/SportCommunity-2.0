...
class TeamFirstProtocolFragment: BaseXmlFragment<FragmentTeamPlayersBinding>(R.layout.fragment_team_players) {
    ...
    private val adapterChoosePLayers: MultiChooseAdapter by lazy {
        MultiChooseAdapter(){ data, _ ->
            viewModel.addPlayerForProtocol(data, true)
        }
    }
    ...
    private fun setupObservers() = viewModel.run {
        liveDataPLayersTeamHome.observe(viewLifecycleOwner){
